...
// Find the start of WorkflowTeardown component
        ...
        <section className="py-24 px-6 md:px-12 bg-navy-950 border-t border-white/[0.06] relative">
          <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-12 lg:gap-20 items-start">
            ...
            <div className="lg:w-8/12 flex flex-col gap-8 w-full">
              ...
              {/* 2. Secondary Static Card (like Vstorm's "30+") */}
...
if (oldBlock && txt.includes(oldBlock)) {
    txt = txt.replace(oldBlock, newBlock);
    fs.writeFileSync('../index.html', txt, 'utf8');
    console.log("Successfully updated WorkflowTeardown to Vstorm's 2-column layout!");
} else {
    console.error("Could not find WorkflowTeardown block to replace.");
}
