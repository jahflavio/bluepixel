...
const startIndex = content.indexOf('const CaseStudiesSection = ({ onOpenCase }) => {');
const endIndex = content.indexOf('const FAQSection = () => {');
      ...
      const cases = [
        {
          ...
          image: './bluepixel-app/public/assets/bimbo.jpg'
        },
        {
          id: 'radioshack',
          client: 'RadioShack',
          ...
          image: './bluepixel-app/public/assets/radioshack.jpg'
        },
        {
          id: 'lifemiles',
          ...
          image: './bluepixel-app/public/assets/lifemiles.jpg'
        },
        {
          id: 'iqos',
          ...
          image: './bluepixel-app/public/assets/iqos.png'
        }
      ];

      const [activeIndex, React.useState] = React.useState ? [0, React.useState] : [0, useState];
      // Use activeIndex safely
      const [active, setActive] = React.useState ? React.useState(0) : useState(0);
...
console.log("Successfully replaced CaseStudiesSection in index.html");
