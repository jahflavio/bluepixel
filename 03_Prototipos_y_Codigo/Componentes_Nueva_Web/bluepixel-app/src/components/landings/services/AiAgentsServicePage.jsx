    ...
    <div className="min-h-screen bg-[#02040A] text-white">
      ...
      <section className="relative pt-32 pb-20 px-6 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10 mt-10">
          <span className="inline-block text-[11px] font-mono uppercase tracking-widest text-purple-400 font-bold border border-purple-500/20 bg-purple-500/10 px-4 py-1.5 rounded-full mb-8 shadow-[0_0_15px_rgba(var(--purple-rgb),0.2)]">
            ✦ PROTOCOLO MCP
          </span>
          ...
          <p className="text-slate-300 text-lg md:text-xl leading-relaxed max-w-2xl mx-auto mb-12">
            Procesos agentizados que liberan capacidad operativa de tu equipo. Tu plataforma responde con inteligencia y datos corporativos reales. IA integrada en lo que ya tienes, potenciando lo que ya funciona.
          </p>
        </div>
      </section>
      ...
      <section className="py-24 px-6 relative border-t border-white/[0.05] bg-[#040711]">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-black mb-4">Inicia tu proyecto de Agentes IA & Automatización</h2>
          ...
          <div className="bg-[#060A14] border border-white/[0.08] rounded-2xl p-2 md:p-6 shadow-2xl relative">
            <MultiStepContact preselectedPackage="Agentes IA & Automatización" hideCloseButton={true} />
          </div>
        </div>
      </section>
    </div>
