...
const regexMethodology = /const ThreeWaysToWork = \(\{ onSelectPackage \}\) => \{[\s\S]*?const EngineeringLeadership = /;
txt = txt.replace(regexMethodology, newMethodology + '\n    const EngineeringLeadership = ');

fs.writeFileSync('../index.html', txt, 'utf8');
console.log("Methodology diagonal timeline flowchart injected.");
