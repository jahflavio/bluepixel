# 🚀 PROPUESTA FINAL DE CAMPAÑAS B2B: BLUEPIXEL + ROCKETING
**Documento Ejecutivo para Junta de Alineación**

---

## 1. ANÁLISIS DE LA PROPUESTA DE ROCKETING VS. ESTRATEGIA BLUEPIXEL

Tras revisar la auditoría forense interna y la nueva propuesta visual enviada por Rocketing (Marpia), encontramos un **alto grado de alineación**. Rocketing ha comprendido la necesidad de abandonar los micro-nichos y concentrar el presupuesto en nuestros grandes pilares de demanda.

### Puntos de Fuerte Alineación (Aprobados) ✅
*   **Estructura de Google Ads por Clusters:** Rocketing agrupó correctamente la estructura en **Marca**, **IA Operacional (Agentes/Automatización)** y **Producto Digital (Apps/Software)**. Esto empata perfectamente con nuestros **3 Clusters de Demanda Real**.
*   **Uso de Landings Dedicadas:** La estrategia de derivar a "Landing 1", "Landing 2" y "Landing 3" concuerda con nuestra directiva de usar páginas herméticas (`/lp/desarrollo-apps-enterprise`, `/lp/automatizacion-procesos-erp`, `/lp/agentes-ia-produccion`).
...
## 2. ARQUITECTURA FINAL CONSOLIDADA (LO QUE PRESENTAREMOS HOY)

Esta es la estructura unificada que integra la propuesta de Rocketing con las directrices y URLs de BluePixel, lista para ejecutarse:

### 🌐 A. GOOGLE ADS (Intención Directa B2B) - $23,500 MXN
**Objetivo:** Capturar la demanda activa de directivos (+$300k ticket).
1.  **Campaña Marca (Brand & Protección)**
    *   *Ad Groups:* BluePixel Core, BluePixel Servicios.
    *   *Destino:* Landing 1 (Diagnóstico Pilar 01).
2.  **Campaña IA & Automatización (Cluster 2 y 3)**
    *   *Ad Groups:* Agentes IA / Protocolo MCP, Automatización de Procesos (SAP/ERP), IA Integrada.
    *   *Destino:* Landing 2 (`/lp/agentes-ia-produccion` y `/lp/automatizacion-procesos-erp`).
3.  **Campaña Producto Digital (Cluster 1)**
    *   *Ad Groups:* Desarrollo de Apps Empresariales, Plataformas y Portales B2B.
    *   *Destino:* Landing 3 (`/lp/desarrollo-apps-enterprise`).
...
1.  **Campañas de Test**
    *   *Ad Groups:* AI Solve a Process, Build an App, Digital Product Rescue.

---

## 3. PUNTOS CRÍTICOS Y CHECKLIST PARA LA JUNTA DE HOY (ACUERDOS A FIRMAR)

1.  [ ] **Atribución de "Bucle Cerrado" (Offline Conversions):** El diagrama actual de Rocketing termina en la "Landing". Para evitar optimizar campañas hacia prospectos que solo llenan formularios pero no compran, requerimos la entrega inmediata del **Developer Token y Customer ID** de Google Ads. Esto permitirá conectar nuestro servidor de IA para devolver la señal de ventas exitosas (tickets >$300k).
