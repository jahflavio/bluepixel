...
const ProductoDigitalLandingPage = ({ onNavigateCluster }) => {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
  ...
  return (
    <div className="min-h-screen bg-[#02040A] text-white selection:bg-blue-500/30">
      <WaysToWorkSubNavbar currentView="producto-digital" onNavigate={onNavigateCluster} />
      ...
      <section className="relative pt-32 pb-20 px-6 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10 mt-10">
          <span className="inline-block text-[11px] font-mono uppercase tracking-widest text-blue-400 font-bold border border-blue-500/20 bg-blue-500/10 px-4 py-1.5 rounded-full mb-8 shadow-[0_0_15px_rgba(59,130,246,0.2)]">
            ● PRODUCTO DIGITAL (BUILD + EVOLVE)
          </span>
          <h1 className="text-4xl md:text-5xl lg:text-7xl font-black text-white tracking-tight leading-[1.05] mb-8 font-display">
            Plataformas y Agentes a producción en <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-300">90 días</span>
          </h1>
          <p className="text-slate-300 text-lg md:text-xl leading-relaxed max-w-2xl mx-auto mb-12">
            De cero a una plataforma de misión crítica. Tomamos responsabilidad absoluta del ciclo End-to-End: construcción de la arquitectura (BUILD) y evolución continua bajo estrictos SLAs (EVOLVE). Todo cumpliendo normativas SOC2 y privacidad LFPDPPP.
          </p>
        </div>
      </section>
      ...
      <section className="py-24 px-6 relative">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-black mb-4">Agenda tu Sesión de Producto Digital</h2>
          ...
          <div className="bg-[#060A14] border border-white/[0.08] rounded-2xl p-2 md:p-6 shadow-2xl relative">
            <MultiStepContact preselectedPackage="Producto Digital (Build & Evolve)" hideCloseButton={true} />
          </div>
        </div>
      </section>
...
export default ProductoDigitalLandingPage;
