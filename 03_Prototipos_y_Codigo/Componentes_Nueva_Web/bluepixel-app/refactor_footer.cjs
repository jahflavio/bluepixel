...
if(txt.match(footerRegex)) {
  txt = txt.replace(footerRegex, newFooter);
  fs.writeFileSync('../index.html', txt, 'utf8');
  console.log("Footer refactored with premium B2B strategy.");
} else {
  console.error("Could not find Footer component in index.html");
}
