...
# 3 & 4. Replace HeroWithPrompt and inject HeroPromptEngine
...
$html = $html.Substring(0, $oldHeroPromptStart) + "    " + $newHeroStr + "`r`n" + $newHeroWithPrompt + "`r`n" + $html.Substring($oldHeroPromptEnd)
