          ...
          <div className="max-w-6xl mx-auto px-6 md:px-12">
            <div className="bg-navy-900 border border-white/[0.06] rounded-[2rem] p-10 md:p-16 lg:p-20 text-center relative overflow-hidden shadow-2xl">
              ...
              <div className="relative z-10 max-w-3xl mx-auto">
                <span className="text-[10px] font-mono tracking-widest uppercase text-blue-400 font-bold mb-6 block">
                ...
                <p className="text-slate-400 text-base md:text-lg leading-relaxed mb-10">
                  Empieza con un Diagnóstico Operativo de 2 semanas. Te entregamos el plano de arquitectura y el ROI cuantificado en pesos antes de escribir una sola línea de código. Si la respuesta es que aún no estás listo para construir, te lo decimos con honestidad.
                </p>
